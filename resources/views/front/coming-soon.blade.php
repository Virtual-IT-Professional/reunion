...
<html class="no-js" lang="en">
    <head>
        <!-- title -->
        <title>CPI Reunion | Cumilla Polytechnic Institute</title>
        <meta charset="utf-8">
                ...
                <div class="row row-cols-1 row-cols-lg-2">
                    ...
                    <div class="col minheight-fullscreen d-flex align-items-center bg-black p-0">                         
                        <div class="text-center padding-three-all sm-padding-15px-all w-100">
                            ...
                            <div data-enddate="2024/10/31 12:00:00" class="countdown text-center counter-box-3 margin-nine-bottom"></div>
                            <div class="bg-extra-dark-gray padding-eight-all lg-padding-five-lr border-radius-6 w-70 xl-w-75 lg-w-80 sm-w-100 mx-auto sm-padding-30px-all">
                                ...
                                <p class="text-medium w-70 xl-w-80 lg-w-90 mx-auto margin-40px-bottom sm-w-100 sm-margin-15px-bottom">We'll be here soon with our new awesome site, but you can register for the reunion.</p>

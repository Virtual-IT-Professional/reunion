            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('modaratorHome') }}" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('/public/admin/velzon/html/default/') }}/assets/images/logo.jpg" class="p-2" alt="" height="80">
                        </span>
                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="apps-chat.html" class="nav-link" data-key="t-chat"> Pending List </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="apps-file-manager.html" class="nav-link"> <span data-key="t-file-manager">Active List</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="apps-todo.html" class="nav-link"> <span data-key="t-to-do">Spam/Reject List</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
